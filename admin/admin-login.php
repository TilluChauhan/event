        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Use these awesome forms to login or create new account in your project for Admin Login</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div role="form">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" id="adlogemail" placeholder="Email" type="email">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" id="adlogpass" placeholder="Password" type="password">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <button type="button" id="adminlog" class="btn btn-primary my-4">Login</button>
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
	$(document).ready(function(){
		$('#adminlog').click(function(){
			var email=$('#adlogemail').val();
			var pass=$('#adlogpass').val();
			console.log(email);
			console.log(pass);
			 var data={'T_email':email,'T_pass':pass}
			 console.log(data);
			 $.ajax({
				type:'POST', 
				...
				success:function(res){
					...
					if(res==1){
						...
						swal("Something Get wrong", "Please Check your information", "error");
					}
